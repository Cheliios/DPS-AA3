...
Tiempolvl3 = 35 //VARIBLE DE INICIO TIEMPO
...
function JUEGOlvl3() {
    ...
    function Aumentar_Puntoslvl3() {
        Puntajelvl3++;
        document.getElementById("Puntajelvl3").innerHTML = Puntajelvl3 + " / 50"
        if (Puntajelvl3 == 50) {
            Puntajelvl3 = 0
            Tiempolvl3 = 35
            function Contactos(){
            Swal.fire({
                title : '𝕱𝖊𝖑𝖎𝖈𝖎𝖙𝖆𝖈𝖎𝖔𝖓𝖊𝖘 𝖕𝖔𝖗 𝖘𝖊𝖗 𝖕𝖆𝖗𝖙𝖊 𝖉𝖊𝖑 <br> 𝕲𝖗𝖚𝖕𝖔 Ｏｍｅｇａ<br><br><img src="src/img/Logo_Omega.png" width = "120px">',
                html: '<b class="Aumentar puntos">𝚂𝚊𝚋𝚒𝚊 𝚚𝚞𝚎 𝚕𝚘 𝚕𝚘𝚐𝚛𝚊𝚛í𝚊𝚜, 𝚗𝚘𝚜 𝚜𝚊𝚕𝚟𝚊𝚜𝚝𝚎 𝚍𝚎 𝚕𝚊 𝚍𝚎𝚜𝚝𝚛𝚞𝚌𝚌𝚒ó𝚗, 𝚙𝚎𝚛𝚘 𝚊𝚑𝚘𝚛𝚊 𝚗𝚘𝚜 𝚎𝚜𝚙𝚎𝚛𝚊 𝚘𝚝𝚛𝚊 𝚕𝚞𝚌𝚑𝚊, 𝚎𝚜𝚙𝚎𝚛𝚎𝚖𝚘𝚜 𝚟𝚘𝚕𝚟𝚎𝚛𝚝𝚎 𝚊 𝚟𝚎𝚛 𝚓𝚞𝚐𝚊𝚗𝚍𝚘 ＩＲＯＮ ＦＩＳＴ ２ 𝚎𝚗 𝚞𝚗 𝚏𝚞𝚝𝚞𝚛𝚘 <br><br> CONTACTOS:<br><br> 71727432@certus.edu.pe <br><br> 71663265@certus.edu.pe <br><br> 70845813@certus.edu.pe <br> </b>',
                icon: 'sucess',
    ...
    function perdistelvl3() {
        if ((document.getElementById("Meteoritolvl3").offsetLeft > 630) ||
            ...
            (document.getElementById("Meteorito4lvl3").offsetLeft > 630)) {
                ...
                alert("Ya𝐧𝐨 𝐡𝐚𝐲 𝐯𝐮𝐞𝐥𝐭𝐚 𝐚𝐭𝐫á𝐬;𝘕𝘖 𝘛𝘌 𝘙𝘐𝘕𝘋𝘈𝘚 𝘚𝘐𝘎𝘜𝘌 𝘐𝘕𝘛𝘌𝘕𝘛𝘈𝘕𝘛𝘖 𝘗𝘈𝘙𝘈 𝘚𝘈𝘓𝘝𝘈𝘙 𝘈 𝘕𝘜𝘌𝘚𝘛𝘙𝘈 𝘛𝘐𝘌𝘙𝘙𝘈.")
