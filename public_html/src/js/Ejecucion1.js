Swal.fire({
    title : '¿Preparado para salvar el mundo? <br><br> <img src="src/img/planeta_tierra.png" width = "120px"><br>',
...
document.getElementById("Fondo").style.background = "url(./src/img/Fondo_Espacio2.jpg)"
...
document.getElementById("Fondo").style.backgroundImage = "url(./src/img/Fondo_Espacio.gif) "
Graficos = 1
}
}
