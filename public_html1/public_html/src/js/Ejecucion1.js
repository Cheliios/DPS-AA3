Swal.fire({
    title : '¿ᴾʳᵉᵖᵃʳᵃᵈᵒ ᵖᵃʳᵃ ˢᵃˡᵛᵃʳ ᵉˡ ᵐᵘⁿᵈᵒ? <br><br> <img src="src/img/planeta_tierra.gif" width = "220px"><br>',
    html: 'ＩＲＯＮ ＦＩＳＴ, 𝑬𝒔 𝒖𝒏 𝒋𝒖𝒆𝒈𝒐 𝒒𝒖𝒆 𝒎𝒆𝒋𝒐𝒓𝒂𝒓𝒂 𝒕𝒖𝒔 𝒓𝒆𝒇𝒍𝒆𝒋𝒐𝒔 𝒂 𝒎𝒆𝒅𝒊𝒅𝒂 𝒒𝒖𝒆 𝒑𝒂𝒔𝒆𝒔 𝒅𝒆 𝒏𝒊𝒗𝒆𝒍, 𝒓𝒆𝒕𝒂𝒏𝒅𝒐𝒕𝒆 𝒄𝒂𝒅𝒂 𝒗𝒆𝒛 𝒎𝒂𝒔 𝒂 𝒎𝒆𝒅𝒊𝒅𝒂 𝒒𝒖𝒆 𝒂𝒗𝒂𝒏𝒄𝒆𝒔 𝒚 𝒅𝒆𝒔𝒃𝒍𝒐𝒒𝒖𝒆𝒂𝒏𝒅𝒐 𝒈𝒓𝒂𝒏𝒅𝒆𝒔 𝒍𝒐𝒈𝒓𝒐𝒔 𝒂𝒍 𝒇𝒊𝒏𝒂𝒍 𝒅𝒆 𝒄𝒂𝒅𝒂 𝒏𝒊𝒗𝒆𝒍, 𝒆𝒔𝒑𝒆𝒓𝒂𝒎𝒐𝒔 𝒕𝒆 𝒅𝒊𝒗𝒊𝒆𝒓𝒕𝒂𝒔 𝒚 𝒅𝒊𝒔𝒇𝒓𝒖𝒕𝒆𝒔 𝒅𝒆 𝒆𝒔𝒕𝒆 𝒈𝒓𝒂𝒏 𝒋𝒖𝒆𝒈𝒐   ',
    icon: 'sucess',
